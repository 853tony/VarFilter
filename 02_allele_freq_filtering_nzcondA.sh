...
#SBATCH -o ./LOG/afFILnz_condA.out.log

#SBATCH -e ./LOG/afFILnz_condA.err.log
...
mv ./LOG/afFILnz_condA.out.log ./LOG/afFILnz.${output_filename}.out.log
mv ./LOG/afFILnz_condA.err.log ./LOG/afFILnz.${output_filename}.err.log
