...
if [[ ! -f "${wkdir}/VarFilter_${models_val}.tsv" ]]; then

	echo "Output file ${wkdir}/VarFilter_${models_val}.tsv NOT exists, execution!!!!!!!!"
    ...
    echo "Output file ${wkdir}/VarFilter_${models_val}.tsv already exists, skipping execution."
fi
        i=$((i+5))
    done
}
