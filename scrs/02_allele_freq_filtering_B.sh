...
#SBATCH -J genetic_incompatibility_MAF_fil_B
...
#SBATCH -o ./genetic_incompatibility_MAF_fil_B.out.log

#SBATCH -e ./genetic_incompatibility_MAF_fil_B.err.log
...
-cp $cp -i ${datadir}/MAF_METADATA_gnomadv4_exomes.tsv \
