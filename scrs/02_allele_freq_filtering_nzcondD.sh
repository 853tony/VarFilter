...
#SBATCH -o ./LOG/afFILnz_condD.out.log

#SBATCH -e ./LOG/afFILnz_condD.err.log
...
mv ./LOG/afFILnz_condD.out.log ./LOG/afFILnz.${output_filename}.out.log
mv ./LOG/afFILnz_condD.err.log ./LOG/afFILnz.${output_filename}.err.log
