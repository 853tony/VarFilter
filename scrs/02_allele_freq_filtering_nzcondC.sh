...
#SBATCH -o ./LOG/afFILnz_condC.out.log

#SBATCH -e ./LOG/afFILnz_condC.err.log
...
mv ./LOG/afFILnz_condC.out.log ./LOG/afFILnz.${output_filename}.out.log
mv ./LOG/afFILnz_condC.err.log ./LOG/afFILnz.${output_filename}.err.log
