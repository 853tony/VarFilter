...
#SBATCH -J genetic_incompatibility_MAF_fil_C
...
#SBATCH -o ./LOG/genetic_incompatibility_MAF_fil_C.out.log

#SBATCH -e ./LOG/genetic_incompatibility_MAF_fil_C.err.log
